            ...
            <tr>
                ...
                <td>
                    ...
                    @if($typeOfWard->is_specified)
                        <input type="text" id="type-of-ward-specified" class="form-control-sm form-control" placeholder="Please enter type of ward here..." name="specified_ward_type_{{$typeOfWard->id}}">
                    @endif
                </td>
                <td>
                    <input type="number" value="0" id="number-of-bed-by-type-of-ward-{{$typeOfWard->id}}" class="form-control form-control-sm" name="no_of_beds_{{$typeOfWard->id}}">
                </td>
            </tr>
            @endforeach
            </tbody>
