        ...
        <div class="page-header float-right">
            <div class="page-title">
                <ol class="breadcrumb text-right">
                    ...
                    <li class="active"><a href="hospital">General List</a></li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header text-center">
                        <strong class="card-title">Hospital by General List</strong>
                            ...
                            <tbody>
                                @foreach($hospitals as $hospital )
                                    <tr>
                                        ...
                                        <td>{{ $hospital->name }}</td>
                                        <td>{{ $hospital->health_centre_categories_id }}</td>
                                        ...
                                        <td>{{ $hospital->service_delivary_id }}</td>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="largeModalLabel">Edit General list</h5>
