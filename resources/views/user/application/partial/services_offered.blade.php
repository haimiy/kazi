        ...
        <table class="table table-sm table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <input type="hidden" id="service-offered-have-add-requirement-{{ $service->id }}" value="{{ $service->have_additional_requirement}}" name="additional_requirement_answer">

                        <input type="hidden" id="service-ids" name="type_of_services_id[]" value="{{ $service->id}}">
                        ...
                        @else
                            @if ($service->have_additional_requirement)
                                ...
                                <div id="service-offered-add-requirement-div-{{ $service->id }}" style="display: none">
                                    ...
                                    <input class="form-control input-sm form-control-sm" type="text" id="service-offered-add-requirement-{{ $service->id }}" placeholder="Enter {{$service->additional_requirement}} here..." name="additional_requirement_answer">
                                </div>
                            @else
