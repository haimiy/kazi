        ...
        <div class="page-header float-right">
            <div class="page-title">
                <ol class="breadcrumb text-right">
                    ...
                    <li class="active"><a href="hospital">doctor_incharge</a></li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="row">
                            <div class="col-md-2">
                            <a href="/doctor_incharge_create"><button type="button" class="btn btn-primary"><i class="fa fa-plus"></i>&nbsp; Add Doctor</button></a>
                            </div>
                        </div> 
                        <br>
                        <div class="row">
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="largeModalLabel">Edit Doctor Incharge</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="/doctor_incharge_update/{{ $user->id }}" method="POST">
                    <div class="row">
                        @csrf
                            ...
                            <div class="card">
                                <div class="card-body card-block">
                                    ...
                                    <div class="form-group">
                                            ...
                                            <small class="form-text text-muted">ex. medical </small>
                                    </div>
                                </div>
                            </div>
                        </div>
