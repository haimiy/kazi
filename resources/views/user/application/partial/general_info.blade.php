    ...
    <div class="card-body">
        ...
        @if(auth()->user()->owner->ownership_type == 'Company')
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <div class="form-group">
                        <input type="text" id="person_incharge" name='person_incharge' disabled value="{{ Auth::user()->first_name. ' '.Auth::user()->middle_name. ' '.Auth::user()->last_name}}" class="form-control" />
                    </div>
                </div>
            </div>
        @endif
        <div class="form-group row">
            ...
            <div class="col-sm-8">
                <div class="form-group">
                    <input type="text" id="person_incharge" name='person_incharge' disabled value="{{ auth()->user()->owner->designation??''}}" class="form-control" />
                </div>
            </div>
        </div>
