                    ...
                    <div class="card card-primary card-tabs">
                        <div class="card-header p-0 pt-1">
                                <ul class="nav nav-tabs" id="application-form-tab" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" data-toggle="pill" href="#step10" role="tab" id="tab-btn-10" onclick="changeCurrentTabVal(9)" >Review</a>
                                    </li>
                                </ul>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="tab-content">
                                    @include('registrar.partials.general_info')
                                    @include('registrar.partials.location')
                                    @include('registrar.partials.nearest_hospital')
                                    @include('registrar.partials.services_offered')
                                    @include('registrar.partials.staffing')
                                    @include('registrar.partials.premises')
                                    @include('registrar.partials.no_of_beds')
                                    @include('registrar.partials.other')
                                    @include('registrar.partials.comments')
                                    @include('registrar.partials.review')
                                </div>
                        </div>
                      <!-- /.card-body -->
                    </div>
