@extends('layouts.app')
@section('title', 'Inspector | Create')
@section('css')
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Inspector Create</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                ...
                <div class="col-md-12">
                  ...
                  @endif
                        <div class="card-header">
                          <h3 class="card-title">Inspector Create</h3>
                        </div>
                         
                        <form method="POST" action="/admin/store_inspector">
                        @csrf
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-6">
                                   ...
                                   <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="inspector_type" :value="old('inspector_type')" placeholder="Inspector Type" />
                                            </div>
                                    </div>
                                  </div>  
