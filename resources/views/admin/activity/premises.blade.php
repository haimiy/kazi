        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Premises</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="row">
                ...
                <div class="col-7">
                    <div class="card">
                        ...
                        @endif
                          <h3 class="card-title">List of all Premises</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                ...
                                <td class="text-center">
                                  <div class="dropdown dropdown-action">
                                      ...
                                      <div class="dropdown-menu dropdown-menu-right">
                                          ...
                                          <form id="delete-{{$premises->id}}" method="POST" style="display: inline" class="dropdown-item" action="/admin/delete_premises/{{ $premises->id }}">
                                              @method('DELETE')
                                              @csrf
                                              <i onclick="deleteHospital( {{$premises->id}} )" class="fa fa-trash m-r-5">Delete</i>
                                          </form>
                                      </div>
                                  </div>
                                </td>
