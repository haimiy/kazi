                ...
                <tr>
                    ...
                    <td>
                        ...
                        @if($occupation->is_specified)
                            <input type="text" id="occupation-specified" class="form-control-sm form-control" placeholder="Please specify here...." name="specified_occupation_{{$occupation->id}}">
                        @endif
                    </td>
                    <td>
                        <input type="number" value="0" id="staffing-full-time-{{$occupation->id}}" class="form-control form-control-sm" name="no_of_full_time_{{$occupation->id}}">
                    </td>
                    <td>
                        <input type="number" value="0" id="staffing-part-time-{{$occupation->id}}" class="form-control form-control-sm" name="no_of_part_time_{{$occupation->id}}">
                    </td>
                </tr>
            @endforeach
            </tbody>
